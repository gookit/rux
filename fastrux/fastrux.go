// Package fastrux is a high-performance HTTP router for Go, using Radix Tree for dynamic routes.
package fastrux
...
func Debug(val bool) {
	debug = val
	if debug {
		color.Info.Println("    NOTICE, fastrux DEBUG mode is opened by fastrux.Debug(true)")
		color.Info.Println("===========================================================")
	}
}

// IsDebug return fastrux is debug mode.
func IsDebug() bool {
	return debug
}
