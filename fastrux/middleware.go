...
// WrapH warp an generic http.Handler as a HandlerFunc
func WrapH(hh http.Handler) HandlerFunc {
	return WrapHTTPHandler(hh)
}

// HTTPHandler warp a generic http.Handler as a HandlerFunc
func HTTPHandler(gh http.Handler) HandlerFunc {
	return WrapHTTPHandler(gh)
}

// WrapHTTPHandler warp a generic http.Handler as a HandlerFunc
...
// WrapHF warp a generic http.HandlerFunc as a HandlerFunc
func WrapHF(hf http.HandlerFunc) HandlerFunc {
	return WrapHTTPHandlerFunc(hf)
}

// HTTPHandlerFunc warp a generic http.HandlerFunc as a HandlerFunc
func HTTPHandlerFunc(hf http.HandlerFunc) HandlerFunc {
	return WrapHTTPHandlerFunc(hf)
}

// WrapHTTPHandlerFunc warp a generic http.HandlerFunc as a HandlerFunc
